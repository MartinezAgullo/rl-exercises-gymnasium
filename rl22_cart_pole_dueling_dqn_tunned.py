...
plt.xlabel("Episode")
plt.ylabel("Loss")
loss_plot_path = os.path.join(OUTPUT_DIR, "rl22_loss_vs_episode.png")
...
plt.xlabel("Episode")
plt.ylabel("Steps")
steps_plot_path = os.path.join(OUTPUT_DIR, "rl22_steps_per_episode.png")
...
plt.xlabel("Episode")
plt.ylabel("Reward")
rewards_plot_path = os.path.join(OUTPUT_DIR, "rl22_rewards_per_episode.png")
...
plt.xlabel("Episode")
plt.ylabel("Epsilon")
epsilon_plot_path = os.path.join(OUTPUT_DIR, "rl22_epsilon_per_episode.png")
