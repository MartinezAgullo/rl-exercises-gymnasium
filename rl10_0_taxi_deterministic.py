"""
Solving Gymansium's Taxi-v3 - Deterministic
- Bellamn eq
...
plt.xlabel("Episode")
plt.ylabel("Reward")
reward_plot_path = os.path.join(OUTPUT_DIR, "rl10_0_rewards_per_episode.png")
...
plt.xlabel("Episode")
plt.ylabel("Steps")
steps_plot_path = os.path.join(OUTPUT_DIR, "rl10_0_steps_per_episode.png")
...
plt.xlabel("Episode")
plt.ylabel("Epsilon")
steps_plot_path = os.path.join(OUTPUT_DIR, "rl1_0_epsilon_per_episode_with_decay.png")
plt.savefig(steps_plot_path, dpi=300)
plt.close()
