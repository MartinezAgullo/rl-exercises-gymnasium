...
using Dueling DQNs as well as double DQN
"""
...
class NeuralNetwork(nn.Module):
    ...
    def __init__(self):
        ...
        # Stream for the Advantage Function
        self.advantage = nn.Linear(HIDDEN_LAYER, number_of_outputs)

        # Stream for the V-value
...
class QNetAgent:
    ...
    def optimize(self):
        ...
        if DOUBLE_DQN:
            # With indexes we get the indexes of which actions are the best
...
plt.xlabel("Episode")
plt.ylabel("Loss")
loss_plot_path = os.path.join(OUTPUT_DIR, "rl21_loss_vs_episode.png")
...
plt.xlabel("Episode")
plt.ylabel("Steps")
steps_plot_path = os.path.join(OUTPUT_DIR, "rl21_steps_per_episode.png")
...
plt.xlabel("Episode")
plt.ylabel("Reward")
rewards_plot_path = os.path.join(OUTPUT_DIR, "rl21_rewards_per_episode.png")
...
plt.xlabel("Episode")
plt.ylabel("Epsilon")
epsilon_plot_path = os.path.join(OUTPUT_DIR, "rl21_epsilon_per_episode.png")
